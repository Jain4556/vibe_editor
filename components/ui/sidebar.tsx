...
function SidebarGroupLabel({
  ...
  return (
    <div
      ...
      className={cn(
        "flex h-8 items-center px-2 text-xs text-sidebar-foreground/70",
        className
      )}
      {...props}
    >
...
function SidebarGroupAction({
  ...
  return (
    <button
      ...
      className={cn(
        "absolute top-3.5 right-3 flex aspect-square w-5 items-center justify-center rounded-none p-0 text-sidebar-foreground transition-transform group-data-[collapsible=icon]:hidden hover:bg-sidebar-accent hover:text-sidebar-accent-foreground",
        className
      )}
      {...props}
    >
...
function SidebarMenuButton({
  ...
  return (
    <button
      ...
      className={cn(
        "flex w-full items-center gap-2 p-2 text-left text-xs hover:bg-sidebar-accent hover:text-sidebar-accent-foreground",
...
function SidebarMenuAction({
  ...
  return (
    <button
      ...
      className={cn(
        "absolute top-1.5 right-1 flex w-5 h-5 items-center justify-center",
        className
      )}
      {...props}
    >
...
function SidebarMenuSubButton({
  ...
  return (
    <a
      ...
      className={cn(
        "flex h-7 items-center gap-2 px-2 text-xs hover:bg-sidebar-accent",
        className
      )}
      {...props}
    >
